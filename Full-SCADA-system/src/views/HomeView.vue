...
const cards = [
  ...
  { to: '/data', icon: 'query_stats', title: 'Data Trend', sub: 'Telemetry Analysis', color: 'secondary', accent: 'rgba(93,230,255,0.5)', glow: 'rgba(93,230,255,0.2)', module: '02' },
  { to: '/alerts', icon: 'warning', title: 'Alerts', sub: 'Critical Events', color: 'error', accent: 'rgba(255,180,171,0.5)', glow: 'rgba(255,180,171,0.2)', module: '03' },
